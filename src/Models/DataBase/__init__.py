...
class DatabaseAccessor(object):
    ...
    def add_new_user(self, user_id: int, account: str, password: str, username: str):
        print("添加用户：")
    ...
    def add_new_revenue_info(self, revenue_id: int, revenue_info: str, relevant_user_id: int):
        print("添加资金信息：")
    ...
    #   根据资金信息id获取用户所有信息
    def get_revenue_info_by_id(self, revenue_id: int):
        print("获取对应id的资金信息：")
    ...
    #   删除对应id的用户
    def delete_user_info_by_id(self, user_id: int):
        print("删除对应id的用户")
    ...
    #   删除对应id的资金信息
    def delete_revenue_info_by_id(self, revenue_id: int):
        print("删除对应id的资金信息")
