...
"font-size:14px")
        ...
        self.label_12.setGeometry(QtCore.QRect(320, 340, 54, 12))
...
"background:transparent;")
        ...
        self.widget.setGeometry(QtCore.QRect(290, 70, 541, 471))
...
"font-size:18px;")
        ...
        self.textEdit_2 = QtWidgets.QTextEdit(self.leaseContract)
        self.textEdit_2.setGeometry(QtCore.QRect(30, 69, 750, 380))
        ...
        self.submitAudit.setGeometry(QtCore.QRect(680, 460, 101, 23))
        ...
        self.lineEdit = QtWidgets.QLineEdit(self.leaseContract)
        self.lineEdit.setGeometry(QtCore.QRect(320, 460, 120, 20))
    ...
    def retranslateUi(self, ManagerWindow):
        ...
        self.label_12.setText(_translate("ManagerWindow", "1f"))
