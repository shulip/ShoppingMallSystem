...
"font-size:16px;")
        ...
        self.immediateApplication.setGeometry(QtCore.QRect(290, 290, 75, 23))
        self.immediateApplication.setStyleSheet("\n"
"font-size:16px;")
...
"font-size:16px;")
        ...
        self.shopNum.setGeometry(QtCore.QRect(120, 60, 120, 25))
        self.shopNum.setStyleSheet("background:rgb(206, 206, 206)")
...
"font-size:22px;")
        ...
        self.ContractWidget.setGeometry(QtCore.QRect(20, 60, 800, 500))
...
"}")
        ...
        self.contractInf.setGeometry(QtCore.QRect(19, 50, 750, 391))
        ...
        self.label_6.setGeometry(QtCore.QRect(20, 460, 81, 21))
        self.label_6.setObjectName("label_6")
        self.label_8 = QtWidgets.QLabel(self.ContractWidget)
        self.label_8.setGeometry(QtCore.QRect(250, 460, 101, 21))
        self.label_8.setObjectName("label_8")
        self.label_10 = QtWidgets.QLabel(self.ContractWidget)
        self.label_10.setGeometry(QtCore.QRect(510, 460, 101, 21))
        self.label_10.setObjectName("label_10")
        self.ASigned = QtWidgets.QCheckBox(self.ContractWidget)
        self.ASigned.setGeometry(QtCore.QRect(360, 460, 71, 20))
        self.ASigned.setCheckable(False)
        self.ASigned.setObjectName("ASigned")
        self.BSigned = QtWidgets.QCheckBox(self.ContractWidget)
        self.BSigned.setGeometry(QtCore.QRect(620, 460, 71, 20))
        self.BSigned.setCheckable(False)
        self.BSigned.setObjectName("BSigned")
        self.rentTime = QtWidgets.QLineEdit(self.ContractWidget)
        self.rentTime.setGeometry(QtCore.QRect(120, 460, 113, 20))
    ...
    def retranslateUi(self, ProprietorWindow):
        ...
        self.label_8.setText(_translate("ProprietorWindow", "甲方签字情况"))
        self.label_10.setText(_translate("ProprietorWindow", "乙方签字情况"))
        self.ASigned.setText(_translate("ProprietorWindow", "已签字"))
        self.BSigned.setText(_translate("ProprietorWindow", "已签字"))
