...
"")
    ...
    def retranslateUi(self, CEOWindow):
        ...
        self.fourthFloor.setText(_translate("CEOWindow", "4f"))
        self.firstFloor.setText(_translate("CEOWindow", "1f"))
        self.thirdFloor.setText(_translate("CEOWindow", "3f"))
        self.secondFloor.setText(_translate("CEOWindow", "2f"))
